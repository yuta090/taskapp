...
const entries: { date: string; title: string; items: { kind: Kind; text: string }[] }[] = [
  {
    ...
    items: [
      { kind: '新機能', text: '1つの議事録を複数人で同時に編集できるようになりました。誰がどこを書いているかが色で分かります。' },
      { kind: '新機能', text: '見出し・折りたたみ・チェックリストを「/」から差し込めるようになりました。' },
      { kind: '新機能', text: '議事録のチェックリストの行から、タスクをまとめて作れるようになりました。' },
      { kind: '新機能', text: '本文からWikiのページ・ファイル・タスクへ直接リンクを貼れるようになりました。' },
  ...
  },
  {
    ...
    items: [
      { kind: '新機能', text: 'タスクにコメントできるようになりました。担当者・承認者・過去にコメントした人に届きます。' },
      { kind: '新機能', text: '承認の結果が、その場で担当者に届くようになりました。' },
      { kind: '改善', text: 'マイタスクで表示を切り替えられるようになり、未読のコメントが分かるようになりました。' },
      { kind: '改善', text: 'ダッシュボードに、期限切れのタスクと最近のコメントが並ぶようになりました。' },
      { kind: '修正', text: '受信トレイで承認依頼が届かないことがあった問題を直しました。' },
    ],
  },
  {
    date: '2026年9月上旬',
    ...
    items: [
      { kind: '新機能', text: '二要素認証を使えるようになりました。認証アプリの6桁コードでログインします。' },
      { kind: '新機能', text: '見慣れない端末からログインがあったとき、メールでお知らせするようにしました。' },
      { kind: '新機能', text: '承認された見積もりから、freee請求書・マネーフォワード・Misoca で書類を作れるようになりました。' },
      { kind: '新機能', text: 'CSVファイルを、表として開いてその場で直せるようになりました。' },
      { kind: '改善', text: 'コマンドライン（agentpm）からファイルを上げられるようになりました。' },
    ],
  },
  {
    date: '2026年7月',
    ...
    items: [
      { kind: '新機能', text: 'LINE・Chatwork・Discord のグループに秘書を入れられるようになりました。' },
      { kind: '新機能', text: '会話から拾ったやることを、1日1回まとめてお届けするようにしました。' },
        ...
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          >
            ...
            <p className="text-sm text-slate-600 leading-relaxed mb-6">
              ここに並んでいるものの多くは、使っている方からの声で作りました。
              困っていることがあれば、遠慮なくお聞かせください。
            </p>
            <Link
              href="/contact"
