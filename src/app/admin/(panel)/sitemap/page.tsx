...
const ROUTES = [
  ...
  },
  {
    ...
    routes: [
      ...
      { path: '/:orgId/project/:spaceId/views/billing', description: '見積書・請求書の作成' },
  ...
  },
  {
    ...
    routes: [
      ...
      { path: '/api/accounting/documents', description: '見積書・請求書の発行／履歴' },
      { path: '/api/accounting/partners', description: '発行先の取引先の一覧／紐付け' },
