            ...
            <div className="flex-grow container mx-auto px-6 py-24 max-w-3xl">
                ...
                <div className="space-y-8">
                    <dl className="divide-y divide-slate-200">
                        {[
                            { dt: '販売業者', dd: '株式会社ソレカラ' },
                            { dt: '運営統括責任者', dd: '代表取締役 高橋木綿子' },
                            { dt: '所在地', dd: '〒130-0021 東京都墨田区緑3丁目2番地1 シティインデックス錦糸町402号室' },
                            { dt: '電話番号', dd: 'ご請求があった場合、遅滞なく開示いたします。お問い合わせフォームよりご請求ください。' },
                            { dt: 'メールアドレス', dd: 'support@agentpm.app' },
                            ...
                            { dt: '返品・返金', dd: '月払いプランはいつでも解約でき、次回請求は発生しません（日割り返金はありません）。年払いプランの途中解約は、未経過月分を月割りで返金します。サービスに重大な障害がある場合は個別に対応します。' },
                        ].map((item) => (
