...
const chapters = [
  {
    ...
    body:
      '画面をひとつずつ開かなくても、コマンドでマイルストーンとタスクを一度に作れます。前に作った企画のタスク一覧をCSVで持ってくれば、そのまま使い回せます。',
    code: [
      'agentpm milestone create --name "企画確定" --due-date 2026-10-15',
      'agentpm task import --file tasks.csv --no-dry-run',
    ],
    note: '取り込みは、まず中身を見せてから聞きます。そのまま入れたいときだけ --no-dry-run を付けます。',
  },
  {
    icon: CheckCircle,
    label: '02 確認',
    ...
    body:
      '確認してほしいタスクに承認を立てると、相手の受信トレイに届きます。承認された日時と、誰が承認したかが残ります。「言った言わない」になりません。',
  ...
  },
  {
    ...
    title: '議題を議事録に書いておく',
    body:
      '会議の議事録は、始まる前から書けます。議題を並べ、気づいたことをメモとして足していく。当日はそれを見ながら進めるだけです。',
  ...
  },
  {
    ...
    body:
      '議事録の本文から、Wikiのページ・過去の議事録・ファイル・タスクに直接リンクを貼れます。あとから「あの資料どこ？」と探さずに済みます。決まったことには決定の札を立てられます。',
    code: [],
    note: '',
  },
  {
    icon: Terminal,
    label: '05 会議のあと',
    title: '話した内容を流し込むと、議事録が仕上がる',
    body:
      '文字起こしやメモのテキストを、そのまま議事録に足せます。チェックリストの行からタスクを作れるので、宿題が抜け落ちません。',
    code: [
  ...
  },
  {
    ...
    body:
      'PDFも画像もCSVも、案件のファイル置き場にまとめられます。CSVは表として開いて、その場で書き換えられます。別のソフトで開いて上書きし直す手間が要りません。',
  ...
  },
  {
    ...
    body:
      'APIキーを発行すれば、Claude や ChatGPT など MCP に対応したAIからつなげます。「いま誰待ちのタスクは？」と聞けば答えますし、そのまま登録もできます。AI経由の操作も監査ログに残ります。',
    code: [],
    note: '鍵は1つのプロジェクトだけに絞ることもできます。いつでも止められます。',
  },
]
        ...
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          >
            ...
            <p className="text-slate-600 text-sm leading-relaxed mb-6">
              会議で決まったこと、その根拠になった資料、そこから生まれたタスク、承認した人。
              ばらばらのツールに置くと、3か月後には誰もたどれません。同じ場所に置けば、
              AIに「この企画の経緯を教えて」と聞くだけで答えが返ってきます。
            </p>
