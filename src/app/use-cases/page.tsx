...
const scenes: SceneData[] = [
    {
        ...
        resultsNote: '※ PM1名+エンジニア3-5名、受託案件での想定値。一定の仮定に基づく試算であり、効果を保証するものではありません。',
    ...
    },
    {
        ...
        resultsNote: '※ 3-5案件並行、ディレクター1-2名体制での想定値。一定の仮定に基づく試算であり、効果を保証するものではありません。',
    ...
    },
    {
        ...
        resultsNote: '※ 1名で2-3案件管理の場合。一定の仮定に基づく試算であり、効果を保証するものではありません。',
        features: ['CLI', 'ポータル', '見積もり・承認', 'CSVエクスポート'],
        extraNote: 'タスクの見積・請求金額をCSVで書き出し、freee・マネーフォワード等に取り込めます。見積書・請求書を直接作るAPI連携（freee請求書／マネーフォワード クラウド請求書／Misoca）は開発中です。いずれも対象は見積書・請求書の作成のみで、会計帳簿や仕訳の連携は行いません。',
    },
    {
        id: 'agency',
        label: '代理店',
        ...
        resultsNote: '※ 制作会社2-3社管理の場合。一定の仮定に基づく試算であり、効果を保証するものではありません。',
