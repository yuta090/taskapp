...
const steps = [
  {
    ...
    title: '登録する',
    time: '3分',
    body: 'メールアドレスとパスワードだけ。クレジットカードの登録はいりません。',
  ...
  },
  {
    ...
    title: 'プロジェクトを作る',
    time: '5分',
    body: '業種のテンプレートを選ぶと、Wikiのページもマイルストーンも入った状態で立ち上がります。白紙から組み立てる必要はありません。',
    details: [
  ...
  },
  {
    ...
    title: '相手先を招待する',
    time: '3分',
    body: 'メールで招待を送るだけ。相手先はパスワードを一度決めれば、そのまま専用の画面に入れます。',
  ...
  },
  {
    ...
    title: 'チャットをつなぐ',
    time: '5分〜',
    body: 'いつも使っているチャットのグループに、AI秘書を入れます。ここから先は、会話から拾ったやることが申し送りとして溜まります。タスクにするかどうかは、人が見て決めます。',
    details: [
      '共通のアカウントなら、グループに招待して合言葉を入れるだけ',
  ...
  },
  {
    ...
    title: 'いまのツールから移す',
    time: '案件による',
    body: '既存のタスクはCSVで持ってこられます。移している間、前のツールと並べて使っても構いません。',
    details: ['書き出したCSVをそのまま取り込めます', 'いまのタスク管理ツールとつないだまま使うこともできます'],
  },
]

const support = [
  { title: 'チャットで質問する', body: '画面を開いたまま、その場で聞けます。' },
  { title: '導入の相談をする', body: '15分いただければ、プロジェクトの分け方とチャットのつなぎ方をご提案します。' },
  { title: 'マニュアルを読む', body: '画面ごとの操作を、写真つきでまとめてあります。' },
]
    ...
    <main className="font-sans antialiased text-slate-900 bg-surface min-h-screen">
      ...
      <section className="pt-32 pb-20 bg-slate-50">
        <div className="container mx-auto px-6 text-center max-w-3xl">
          ...
          >
            登録からチャットをつなぐまで、あわせて20分ほどです。<br className="hidden md:block" />
            いま使っているツールを、いきなり止める必要もありません。
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          >
            ...
            <p className="text-slate-500 text-sm">3つの窓口があります。どれから声をかけていただいても構いません。</p>
          </motion.div>
