 ...
 *
 * 元は SpaceConnectionList 内のprivateコンポーネントだったが、連携ハブ(ClientLinkPanel)
 * からも同じ挙動で使うため export して共有する（挙動・API呼び出しは一切変えない純粋抽出）。
 */
export function LinkCodeIssueButton({ orgId, spaceId }: LinkCodeIssueButtonProps) {
