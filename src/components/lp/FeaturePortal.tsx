...
import { CurrencyJpy, ShieldCheck } from '@phosphor-icons/react'
...
export function FeaturePortal() {
  return (
    <section id="for-clients" className="py-20 bg-slate-50 relative overflow-hidden">
          ...
          >
            ...
            <div className="bg-slate-100 rounded-xl p-4 mb-6">
              <div className="flex items-center gap-2 mb-3">
                <ShieldCheck size={18} className="text-slate-700" weight="bold" />
                <span className="text-sm font-bold text-slate-800">セキュリティ</span>
              </div>
