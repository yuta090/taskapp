...
export function MilestoneGroupHeader({
  ...
  return (
    <div
      className="sticky top-0 z-10 bg-surface flex items-center gap-2 px-4 md:px-2 py-2.5 cursor-pointer hover:bg-gray-50 transition-colors select-none border-b border-gray-100"
      onClick={onToggle}
    >
      {/* Collapse toggle */}
