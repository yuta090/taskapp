  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div
          ref={panelRef}
          className="absolute right-0 top-full mt-2 w-[360px] max-h-[480px] bg-surface rounded-lg shadow-lg border border-gray-200 flex flex-col z-50 overflow-hidden"
        >
          {/* Header */}
