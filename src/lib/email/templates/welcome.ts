...
export function buildWelcomeEmailContent(params: WelcomeEmailContentParams): WelcomeEmailContent {
  ...
  const subject = `【${appName}】ようこそ！最初の3ステップ + LINE秘書連携`
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 32px 0;">
                ...
                <tr>
                  <td style="padding: 12px 0;">
                    <p style="margin: 0; color: #111827; font-size: 15px; font-weight: 600;">④ LINE秘書と連携</p>
                    <p style="margin: 4px 0 0 0; color: #6b7280; font-size: 14px; line-height: 1.5;">秘書コンソールのQRで友だち追加し、表示されたコードをトークに送信すると連携完了です（追加だけでは連携されません）。</p>
                  </td>
                </tr>
              </table>
              <!-- CTA Button -->
...
④ LINE秘書と連携
秘書コンソールのQRで友だち追加し、表示されたコードをトークに送信すると連携完了です（追加だけでは連携されません）。
