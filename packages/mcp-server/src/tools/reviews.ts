 ...
 */
export async function reviewCancel(params: z.infer<typeof reviewCancelSchema>): Promise<{ ok: boolean }> {
  ...
  if (error) throw mapRaiseExceptionError(error.message, 'レビューの取り消しに失敗しました')
