...
export async function schedulingCreate(params: z.infer<typeof schedulingCreateSchema>) {
  ...
  if (proposalError) throw hideDbErrorWithHint(proposalError, 'create_scheduling_proposal', '提案の作成に失敗しました')
  ...
  if (slotsError) throw hideDbErrorWithHint(slotsError, 'create_scheduling_proposal (slots)', '候補日時の作成に失敗しました')
  ...
  if (respondentsError) throw hideDbErrorWithHint(respondentsError, 'create_scheduling_proposal (respondents)', '回答者の登録に失敗しました')
...
export async function schedulingGetResponses(params: z.infer<typeof schedulingResponsesSchema>) {
  ...
  if (respondentError) throw hideDbErrorWithHint(respondentError, 'get_proposal_responses (respondents)', '回答者情報の取得に失敗しました')
  ...
  if (slotsError) throw hideDbErrorWithHint(slotsError, 'get_proposal_responses (slots)', 'スロット情報の取得に失敗しました')
...
export async function schedulingSendReminder(params: z.infer<typeof schedulingReminderSchema>) {
  ...
  if (respondentError) throw hideDbErrorWithHint(respondentError, 'send_proposal_reminder (respondents)', '回答者情報の取得に失敗しました')
  ...
  if (insertError) throw hideDbErrorWithHint(insertError, 'send_proposal_reminder (notifications)', 'リマインド送信に失敗しました')
