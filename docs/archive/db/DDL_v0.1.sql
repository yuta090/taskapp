-- Postgres DDL v0.1
-- Includes: orgs, spaces, milestones, tasks, publications, wiki, meetings/transcripts,
-- LLM runs, invites, discussion items, onboarding progress, github integration minimal
-- NOTE: Enable pgcrypto for gen_random_uuid()
