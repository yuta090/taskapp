...
![プロジェクト設定。左のメニューから各項目に移動します。](/img/help/project-settings.webp)
...
> **招待については編集者もできます。**メンバーの招待・取り消し・送り直しは、管理者だけでなく
> **編集者**も操作できます（役割の変更は管理者のみ）。招待メールの文面はその場で書き換えられ、
> 「テンプレートとして保存」できるのは事務所の管理者だけです。
