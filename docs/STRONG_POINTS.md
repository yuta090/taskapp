...
| ツール | 「待ち」の表現 | 問題点 |
|--------|---------------|--------|
| 課題管理型 | カスタムステータス | 手動、不統一、強制力なし |
| タスク管理型 | カスタムフィールド/タグ/ラベル | ワークフロー連携・監査証跡なし |
| ドキュメント型 | プロパティ | 自由すぎて統一困難 |
...
| ツール | クライアントアクセス | 問題点 |
|--------|-------------------|--------|
| 課題管理型 | 制限付きアカウント | 複雑な権限設定、情報漏洩リスク |
| タスク管理型 | ゲストアクセス | 内部タスクも見える可能性 |
| ドキュメント型 | 共有ページ | 構造が見える、編集リスク |
